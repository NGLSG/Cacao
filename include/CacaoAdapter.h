...
namespace Cacao
{
    ...
    class CACAO_API CacaoAdapter : public std::enable_shared_from_this<CacaoAdapter>
    {
    public :
        virtual ~CacaoAdapter() = default;
        ...
        virtual std::shared_ptr<CacaoDevice> CreateDevice(const CacaoDeviceCreateInfo& info) = 0;
