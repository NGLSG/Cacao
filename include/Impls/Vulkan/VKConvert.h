...
namespace Cacao
{
    ...
    public:
        ...
        static vk::PipelineStageFlags Convert(PipelineStage flags);
        static vk::AccessFlags Convert(AccessFlags flags);
        static vk::ImageLayout Convert(ImageLayout layout);
